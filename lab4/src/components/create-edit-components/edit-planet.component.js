...
export default class EditPlanet extends Component {
  ...
  componentDidMount() {
    axios.get('http://localhost:5000/planet/'+this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  onSubmit(e) {
    ...
    axios.post('http://localhost:5000/planet/update/' + this.props.match.params.id, planet)
